...
exports.tools = [
    {
        ...
        function: {
            name: "changeStarName",
            description: "To change Star's default name. Call this when the user wants to rename Star",
            parameters: {
                type: "object",
                properties: {
                    name: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "To change Star's default language of communication. Call this when the user wants to speak to Star in a different language",
            parameters: {
                type: "object",
                properties: {
                    language: {
    ...
    },
    {
        ...
        function: {
            name: "playMusic",
            description: "To search for music and play it. The video is not visible to the user while the audio is playing. Do not mention the source of the music in the response.",
            parameters: {
                type: "object",
                properties: {
                    query: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "Call this function whenever the user shares new personal information, preferences, or habits. This helps maintain an evolving profile of the user over time. You can track details about their interests, lifestyle, routines, preferences (e.g., favorite music, food, movies, books), and general patterns. Avoid calling this function for temporary or one-time details unless they are part of a recurring trend. Do not explicitly tell the user every time you save something unless relevant to the conversation.",
            parameters: {
                type: "object",
                properties: {
                    key: {
                        type: "string",
                        description: "The category or aspect of the user’s profile to update (e.g., 'favoriteMusic', 'dietaryPreference', 'commuteHabit').",
                    },
                    value: {
                        type: "string",
                        description: "The specific information to store (e.g., 'jazz', 'vegetarian', 'prefers biking').",
                    },
                },
                additionalProperties: false,
                required: ["key", "value"],
